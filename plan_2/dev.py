...
from plan_2.evaluator_dev import evaluation
import time
import pickle
...
def run_dev(opt, processor, info_dict, dev_info=None):
    ...
    print(tmp_metric_str, tmp_f1, tmp_f1_bio)
...
def main(opt):
    ...
    run_dev(opt, processor, info_dict, dev_info)
