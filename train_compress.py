...
from Client.model_utils import ClientCompressModel
from Service.model_utils import SeviceCompressModel
...
def train_with_best(opt, processor, info_dict, train_examples, dev_info=None):
    ...
    client_model = ClientCompressModel(opt.bert_dir, dropout_prob=opt.dropout_prob, k=2)
    service_model = SeviceCompressModel(opt.bert_dir, dropout_prob=opt.dropout_prob, k=2)
