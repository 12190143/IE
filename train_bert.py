...
from trainer_bert import train_best
from options import TrainArgs
from model_utils import BertNERModel
...
def train_with_best(opt, processor, info_dict, train_examples, dev_info=None):
    ...
    model = BertNERModel(opt.bert_dir, dropout_prob=opt.dropout_prob)
    ...
    train_best(opt, model, train_dataset, dev_info, info_dict)
